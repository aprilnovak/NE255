...
\begin{figure}[H]
  \centering
  \includegraphics[width=16cm]{ScalarFlux_partC.jpg} % versioned
...
\begin{figure}[H]
  \centering
  \includegraphics[width=12cm]{ScalarFlux_partD.jpg} % versioned
...
\lstinputlisting[language=Matlab]{Q3partCD.m}
